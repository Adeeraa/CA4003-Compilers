/* Generated By:JJTree&JavaCC: Do not edit this line. CALParserTokenManager.java */
import java.util.*;
import java.io.*;
...
/** Constructor. */
public CALParserTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public CALParserTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
